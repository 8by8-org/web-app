...
describe('Actions', () => {
  ...
  it('checks if the correct elements appear when the user has registered to vote and started the challenge', async () => {
    const userInfo = Builder<User>().name('Test').avatar('1').registeredVoter(true).notifyElectionReminders(false).startedChallenge(true).build();
