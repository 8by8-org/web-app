...
describe('Actions', () => {
  ...
  it('checks if the correct elements appear when the user has signed up for election reminders and started the challenge', async () => {
    const userInfo = Builder<User>().name('Test').avatar('1').registeredVoter(false).notifyElectionReminders(true).startedChallenge(true).build();
