...
describe('Actions', () => {
  ...
  it('checks if the correct elements appear when the user has started the challenge', async () => {
    const userInfo = Builder<User>().name('Test').avatar('1').registeredVoter(false).notifyElectionReminders(false).startedChallenge(true).build();
