...
describe('Actions', () => {
  ...
  it('checks if the correct elements appear when the user has completed one action and the inviter has finished their challenge and the reward that has been chosen has expired', async () => {
