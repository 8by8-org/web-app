...
describe('Actions', () => {
  ...
  it('checks if the correct elements appear when the user has completed one action and the inviter has finished their challenge and a reward with an end date has been chosen', async () => {
    ...
    const rewards = Builder<Rewards>([{
      ...
      rewardEndDate: new Date("2024-09-01"),
