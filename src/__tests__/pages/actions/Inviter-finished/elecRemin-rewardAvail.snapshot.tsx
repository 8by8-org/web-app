...
describe('Actions', () => {
  ...
  it('checks if the correct elements appear when the user has completed one action and the inviter has finished their challenge and rewards are available', async () => {
    const userInfo = Builder<User>().name('Test').avatar('1').registeredVoter(false).notifyElectionReminders(true).startedChallenge(false).build();
