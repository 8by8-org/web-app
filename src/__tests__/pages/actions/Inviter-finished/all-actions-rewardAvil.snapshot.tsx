...
describe('Actions', () => {
  ...
  it('checks if the correct elements appear when the user has completed all actions and the inviter has finished their challenge and rewards are available', async () => {
