  ...
  return (
    <div className="Legal">
      ...
      <p>
        ...
        of 8by8 Inc.'s Website, located at app.8by8.us.
      </p>
      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use 8by8 Challenge if you do not agree to
      ...
      <h2>Cookies</h2>
      <p>
        We employ the use of cookies. By accessing 8by8 Challenge, you agreed to
        use cookies in agreement with the 8by8 Inc.'s{" "}
      ...
      <h2>License</h2>
      <p>
        Unless otherwise stated, 8by8 Inc. and/or its licensors own the
        intellectual property rights for all material on 8by8 Challenge. All
        intellectual property rights are reserved. You may access this from 8by8
        Challenge for your own personal use subject to restrictions set in these
        terms and conditions.
      </p>
      <p>
        You must not:
        <ul>
          <li>Republish material from 8by8 Challenge</li>
          <li> Sell, rent or sub-license material from 8by8 Challenge</li>
          <li> Reproduce, duplicate or copy material from 8by8 Challenge </li>
          <li>Redistribute content from 8by8 Challenge</li>
        </ul>
      ...
      <h2>Hyperlinking to out Content</h2>
      <p>
      ...
      <p>
        ...
        the hyperlink compensates the absence of 8by8 Inc.; and (d) the link is
      ...
      <p>
        ...
        e-mail to 8by8 Inc. at 8by8vote@gmail.com. Please include your name,
      ...
      <p>
        No use of 8by8 Inc.'s logo or other artwork will be allowed for linking
      ...
      <h2>Your Privacy</h2>
      <p>
        Please read <a href="/privacypolicy">Privacy Policy</a>.
      </p>
