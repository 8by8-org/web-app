...
import styles from '@/styles/modules/components/header/hamburger-links/hamburger-links-player.module.scss';

type HamburgerLinksPlayerProps = {
  hideMenu:() => void;
}

export default function HamburgerLinksPlayer({hideMenu}:HamburgerLinksPlayerProps) {
