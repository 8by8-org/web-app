...
function Invite({ toggleInvite , isShare, won}) {
  ...
  const shareUrl = url;
  const quote = isShare ?
    "I’m supporting " + JSON.parse(localStorage.getItem("challengerInfo")).name + "'s 8by8 Challeng!"
  :
    won ? "I won the 8by8 Challenge!" : "Help me in my 8by8 Challenge to #stopasianhate.";
