      ...
      <div className="main-content">
        <div>
          <h2 className="heading">
            <u className="underline">Support</u> Yang's 8by8 Challenge!
          </h2>
          <div align="center">
            <img src={Calendar} />
          </div>
        ...
        <div className="text">
          <p>
            <b>
              Help "challenger" win their <u>8BY8 Challenge</u> by registering
              to vote or taking other ctions to #stopasianhate!
            </b>
          </p>
        </div>
        <div>
        ...
        <p className="subheading">1. ALL WE NEED IS YOUR ACTION</p>
        <p className="text">
        ...
        <p className="text">
          ...
          action you take, the better! Note that you can only help earn on badge
          per friend.
        </p>
        <div className="image">
