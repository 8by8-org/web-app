...
import "../Landing/HomePage/HomePageInfo.scss";
...
export default function LandingPageInfo() {
  ...
  return (
    <div style={bodyStyle}>
      <div style={divStyle}>
        <p className="bebas-neue secondary-col">Take the 8by8 challenge</p>
        <p className="montserrat tertiary-col">
          Asian American Pacific Islanders (AAPI) have one of the lowest voter
          turnout and are underrepresented in elected office. You can help us
          make a change.
        </p>
        ...
        <p className="bebas-neue white-col">
          Invite
          <span className="secondary-col"> 8 </span>
          of your friends to register to vote in
          <span className="secondary-col"> 8 </span>
          days. <br /> Earn rewards from local AAPI-owned restaurants.
        </p>
      </div>
    </div>
  );
